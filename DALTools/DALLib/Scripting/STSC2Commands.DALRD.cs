...
namespace DALLib.Scripting
{
    public static partial class STSC2Commands
    {
        ...
        public static List<Command> DALRDCommands = new List<Command>()
        {
            ...
            new Command("SubStart", null),
            new Command("SubEnd", null),
            new Command("SubEndWait", null),
            new CommandFuncCall(),
            new CommandReturn(),
            ...
            new Command("SeWait", null),
            new Command("SeVolume", null),
            ...
            new Command("DispTone", null),
            new Command("FadeWait", new [] { typeof(STSC2Node) }),
            new Command("ExiWait", null),
            ...
            new Command("MapPlace", new [] { typeof(STSC2Node), typeof(int), typeof(int)}), // TODO
            new Command("MapChara", null),
            new Command("MapBg", null),
            new Command("MapCoord", null),
            ...
            new Command("DateSet", null),
            new Command("TellOpen", null),
            new Command("TellClose", null),
            ...
            new Command("Blur+ On/Off", null),
            new Command("BlurPowerFade", null),
            new Command("Monologue+ On/Off", null),
            new Command("Mirage+ On/Off", new [] { typeof(STSC2Node), typeof(bool) }),
            // 0x70
            new Command("MiragePowerFade", null),
            new Command("MessageVoiceWait", null),
            ...
            new Command("DateRestNumber", null),
